...
namespace MD.Xamarin.iOS.Interfaces
{
    ...
    public class CustomPopUpView : UIView
    {
        ...
        private readonly UIVisualEffectView _effectView = new UIVisualEffectView(UIBlurEffect.FromStyle(UIBlurEffectStyle.Dark));
        private readonly UIButton _btnClose = new UIButton(UIButtonType.Custom);
        private readonly UIButton _actionBtn = new UIButton(UIButtonType.Custom);
        private const float CornerRadius = 10;
        private readonly nfloat _btnHeight = 40;
        ...
        public CustomPopUpView(string message, string yesButtonText, string noButtonText, CGSize size)
        {
            ...
            _btnClose.SetTitleColor(UIColor.FromRGB(255, 82, 82), UIControlState.Normal);
            ...
            _actionBtn.BackgroundColor = UIColor.FromRGB(255, 82, 82);
            _actionBtn.SetTitleColor(UIColor.White, UIControlState.Normal);
            _actionBtn.TouchUpInside += delegate
            {
                YesButtonClicked?.Invoke();
